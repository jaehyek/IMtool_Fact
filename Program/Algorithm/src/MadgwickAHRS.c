...
//---------------------------------------------------------------------------------------------------
// Definitions
//#define	// sample frequency in Hz


//---------------------------------------------------------------------------------------------------
// Variable definitions
 extern double sampleFreq;
extern double beta;								// 2 * proportional gain (Kp)
volatile double q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f,q4=0.0f;	// quaternion of sensor frame relative to auxiliary frame
...
#define twoKpDef	(2.05f * 0.5f)	// 2 * proportional gain
#define twoKiDef	(0.1 * 0.5f)	// 2 * integral gain
volatile double twoKp = twoKpDef;											// 2 * proportional gain (Kp)
volatile double twoKi = twoKiDef;		
volatile double integralFBx = 0.0f,  integralFBy = 0.0f, integralFBz = 0.0f;	
